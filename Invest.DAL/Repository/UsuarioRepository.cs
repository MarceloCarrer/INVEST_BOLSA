...
namespace Invest.DAL.Repository
{
    public class UsuarioRepository : RepositoryGeneric<Usuario>, IUsuarioRepository
    {
        ...
        public UsuarioRepository(Context context, SignInManager<Usuario> gerenciadorLogin, UserManager<Usuario> gerenciadorUsuarios) : base(context)
        {
            _context = context;
        ...
        public async Task<IdentityResult> CreateUser(Usuario usuario, string senha)
        {
            try
            {
        ...
        public async Task IncludeUserFunction(Usuario usuario, string funcao)
        {
            try
            {
        ...
        public async Task<int> GetAmountRegistersUsers()
        {
            try
            {
        ...
        public async Task<IList<string>> GetFunctionUser(Usuario usuario)
        {
            try
            {
